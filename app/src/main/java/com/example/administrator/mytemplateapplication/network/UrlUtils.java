...
public class UrlUtils {
    ...
    private UrlUtils() {
        ...
        commonParamsTreeMap.put(Constant.MOBILE_TYPE, "2");
    ...
    private String getSign(TreeMap map) {
        ...
        try {
            ...
            System.out.println("sb.toString()" + Constant.APP_KEY + getToken() + sign);
            signa = MDUtil.encode(MDUtil.TYPE.MD5, Constant.APP_KEY + getToken() + sign).toUpperCase();
        } catch (Exception e) {
            e.printStackTrace();
        }
        return signa;

package com.example.administrator.mytemplateapplication.tools.log;
...
import com.example.administrator.mytemplateapplication.tools.Config;
...
import com.example.administrator.mytemplateapplication.tools.utils.DateUtil;
import com.example.administrator.mytemplateapplication.tools.utils.PermissionCheck;
...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    private boolean handleException(Throwable tr) {
        ...
        new Thread() {
            ...
            public void run() {
                Looper.prepare();
                Toast toast = Toast.makeText(mContext, "selfdefine message", Toast.LENGTH_LONG);

...
-keepclassmembers public class com.erongdu.wireless.views.RDWebViewClient{
   <fields>;
   <methods>;
   public *;
   private *;
...
#这个根据自己的project来设置，这个类用来与js交互，所以这个类中的 字段 ，方法， 等尽量保持
-keepclassmembers public class com.company.loan.common.ui.WebViewCtrl{
   <fields>;
   <methods>;
   public *;
   private *;
...
#有盾
# Gson
-keepattributes Signature -keepattributes *Annotation* -keep class sun.misc.Unsafe { *; }
-keepclassmembers class * implements java.io.Serializable {
static final long serialVersionUID;
